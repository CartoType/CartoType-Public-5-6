...
void MapForm::DrawDrivingInstructions(CartoType::CGraphicsContext& aGc,const CartoType::TRect& aMapClientArea)
    ...
    CartoType::TPoint p;
    instruction_font.DrawText(nullptr,m_first_turn_instruction,p,text_param,text_metrics);
    CartoType::TFixed text_width = text_metrics.iAdvance.iX;
    distance_and_time_font.DrawText(nullptr,m_remaining_distance_text,p,text_param,text_metrics);
