...
void RouteProfileDialog::Copy(CartoType::TRouteProfileType aType)
    ...
    switch (aType)
        {
        case CartoType::ECarRouteProfile: default: s = "Copy driving route profile"; break;
        case CartoType::EBicycleRouteProfile: s = "Copy cycling route profile"; break;
        case CartoType::EWalkingRouteProfile: s = "Copy walking route profile"; break;
        case CartoType::EHikingRouteProfile: s = "Copy hiking route profile"; break;
        }
...
void RouteProfileDialog::on_copyDrive_clicked()
    {
    Copy(CartoType::ECarRouteProfile);
    }

void RouteProfileDialog::on_copyCycle_clicked()
    {
    Copy(CartoType::EBicycleRouteProfile);
    }

void RouteProfileDialog::on_copyWalk_clicked()
    {
    Copy(CartoType::EWalkingRouteProfile);
    }

void RouteProfileDialog::on_copyHike_clicked()
    {
    Copy(CartoType::EHikingRouteProfile);
    }
