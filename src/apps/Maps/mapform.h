...
enum class TExtendedRouteProfileType
    {
    EDrive = int(CartoType::ECarRouteProfile),
    ECycle = int(CartoType::EBicycleRouteProfile),
    EWalk = int(CartoType::EWalkingRouteProfile),
    EHike = int(CartoType::EHikingRouteProfile),
    ECustom
    };

class MapForm: public QOpenGLWidget, public CartoType::MNavigatorObserver
    {
    Q_OBJECT
